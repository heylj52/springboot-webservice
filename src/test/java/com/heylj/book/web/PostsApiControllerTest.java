...
import com.heylj.book.domain.posts.PostsRepository;
...
//JPA 기능 테스트할 때는 @SpringBootTest, @TestRestTemplate을 사용
...
class PostsApiControllerTest {
    ...
    @Test
    @WithMockUser(roles = "USER") // 인증된 가짜 사용자를 만들어서 요청. ROLE_USER 권한
